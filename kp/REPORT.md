...
Для парсинга файла я решил выбрать язык Python, поскольку он позваляет это делать удобно и, на мой взгляд, элегантно. С помощью регулярных выражений я находил необходимые мне строки и вычленял оттуда ID, имена и фамилии. Затем я создавал словарь вида
"ID - имя, фамилия"
